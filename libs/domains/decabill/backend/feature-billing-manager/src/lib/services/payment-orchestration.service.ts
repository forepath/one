...
import { PAYMENT_PROCESSOR_REGISTRY } from '@forepath/decabill/backend/util-plugin-host';
...
export class PaymentOrchestrationService {
  ...
  constructor(
    ...
    @Inject(PAYMENT_PROCESSOR_REGISTRY)
    private readonly paymentProcessorRegistry: ProviderRegistry<PaymentProcessor>,
  ...
  private async initiatePaymentForInvoice(
    ...
    const processor = this.paymentProcessorRegistry.getProvider(processorType);
