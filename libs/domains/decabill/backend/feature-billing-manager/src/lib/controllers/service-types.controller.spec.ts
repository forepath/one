...
import { BillingProvisioningMetadataRegistry } from '@forepath/decabill/backend/util-plugin-host';
    ...
    it('should return server types for a provider', async () => {
      ...
      const moduleRef = await Test.createTestingModule({
        ...
        providers: [
          ...
          { provide: BillingProvisioningMetadataRegistry, useValue: { getProviders: jest.fn() } },
  ...
  describe('getProviders', () => {
    it('should return provider details from registry', async () => {
      ...
      const moduleRef = await Test.createTestingModule({
        ...
        providers: [
          { provide: ServiceTypesRepository, useValue: {} },
          { provide: BillingProvisioningMetadataRegistry, useValue: providerRegistry },
