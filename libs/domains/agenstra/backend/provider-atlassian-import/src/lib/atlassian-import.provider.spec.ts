...
import { atlassianFetchJson } from './utils/atlassian-rest.util';
...
import { TicketStatus } from '@forepath/agenstra/backend/feature-agent-controller';
import { ExternalImportSyncMarkerService } from '@forepath/agenstra/backend/feature-agent-controller';
import { KnowledgeTreeService } from '@forepath/agenstra/backend/feature-agent-controller';
import { TicketsService } from '@forepath/agenstra/backend/feature-agent-controller';

import { AtlassianImportProvider } from './atlassian-import.provider';

jest.mock('./utils/atlassian-rest.util', () => ({
  ...jest.requireActual('./utils/atlassian-rest.util'),
