# agenstra-backend-feature-agent-controller
...
```typescript
import { ClientsService } from '@forepath/agenstra/backend';
...
```bash
nx test agenstra-backend-feature-agent-controller
```

Run tests with coverage:

```bash
nx test agenstra-backend-feature-agent-controller --coverage
```
