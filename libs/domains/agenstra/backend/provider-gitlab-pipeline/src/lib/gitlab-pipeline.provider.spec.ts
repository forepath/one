...
import { PipelineProviderCredentials } from '@forepath/agenstra/backend/util-plugin-host';
...
describe('GitlabPipelineProvider', () => {
  let provider: GitlabPipelineProvider;
  ...
  beforeEach(async () => {
    ...
    provider = module.get<GitlabPipelineProvider>(GitlabPipelineProvider);
  });
