 ...
 */
@Injectable()
export class GitlabPipelineProvider implements PipelineProvider {
  private readonly logger = new Logger(GitlabPipelineProvider.name);
   ...
   */
  getType(): string {
    return GitlabPipelineProvider.TYPE;
  }
  ...
  private getApiBaseUrl(credentials: PipelineProviderCredentials): string {
    ...
    return GitlabPipelineProvider.API_BASE_URL;
  }
