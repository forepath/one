...
describe('ChatFilterBidirectionalProvider', () => {
  let filter: ChatFilterBidirectionalProvider;
  ...
  beforeEach(async () => {
    ...
    filter = module.get<ChatFilterBidirectionalProvider>(ChatFilterBidirectionalProvider);
  });
